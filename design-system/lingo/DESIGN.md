...
Bright, rounded, tactile 3D, friendly illustrated consumer experiences.

Use this style when the interface should feel friendly, expressive, approachable, and warm. The design should be recognizable as Lingo, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Lingo
...
- **Primary:** `#58cc02` - main actions, active states, and key highlights.
- **Secondary:** `#ce82ff` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#FFFFFF` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#3c3c3c` - primary readable content.
- **Neutral:** `#FFFFFF` - borders, muted backgrounds, dividers, or inactive UI.
- **Success:** `#58cc02` - completed, positive, or confirmed states.
- **Warning:** `#ffc800` - caution, pending, or review-needed states.
- **Danger:** `#ff4b4b` - destructive, failed, or high-risk states.

Keep color usage role-based. Do not introduce new raw colors unless they extend this palette deliberately.

### Typography

- **Display / H1:** Nunito, `2rem`
- **Body:** Nunito, `1rem`
