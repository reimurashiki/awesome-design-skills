...
High-contrast expressive interfaces with creative typography and striking color choices.

Use this style when the interface should feel confident, high-contrast, memorable, and energetic. The design should be recognizable as Artistic, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Artistic
