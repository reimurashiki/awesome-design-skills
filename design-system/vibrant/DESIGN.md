...
# Vibrant Design Style

## Overview

Lively color, playful typography, warm accents, and dynamic visual energy.

Use this style when the interface should feel quiet, clear, focused, and deliberately simple. The design should be recognizable as Vibrant, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Vibrant
...
- **Primary:** `#7C61D4` - main actions, active states, and key highlights.
- **Secondary:** `#EAAE87` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#FFFFFF` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#2F281D` - primary readable content.
...
- **Display / H1:** Fascinate, `2.5rem`
- **Body:** Noto Sans, `1rem`
- **Labels / metadata:** Fira Code, `0.875rem`
