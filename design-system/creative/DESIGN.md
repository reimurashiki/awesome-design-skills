...
Playful, character-driven landing pages and bold graphics for creative projects.

Use this style when the interface should feel friendly, expressive, approachable, and warm. The design should be recognizable as Creative, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Creative
