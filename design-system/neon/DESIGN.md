...
Electric glow, high contrast, and attention-grabbing neon color pairings.

Use this style when the interface should feel technical, focused, intelligent, and forward-looking. The design should be recognizable as Neon, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Neon
...
- **Primary:** `#BBF351` - main actions, active states, and key highlights.
- **Secondary:** `#00BCFF` - supporting accents, secondary surfaces, or tonal variation.
...
- **Display / H1:** STIX Two Text, `2.5rem`
- **Body:** Roboto, `1rem`
- **Labels / metadata:** Source Code Pro, `0.875rem`
