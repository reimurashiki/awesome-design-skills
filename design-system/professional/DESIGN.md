...
Business-ready trust, modern typography, structured layouts, and polished identity.

Use this style when the interface should feel polished, persuasive, clear, and conversion-aware. The design should be recognizable as Professional, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Professional
...
- **Primary:** `#FECE14` - main actions, active states, and key highlights.
- **Secondary:** `#000000` - supporting accents, secondary surfaces, or tonal variation.
