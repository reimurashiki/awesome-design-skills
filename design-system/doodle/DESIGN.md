...
Hand-drawn, sketch-like, handwritten, imperfect, playful informal UI.

Use this style when the interface should feel friendly, expressive, approachable, and warm. The design should be recognizable as Doodle, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Doodle
...
- **Primary:** `#49B6E5` - main actions, active states, and key highlights.
- **Secondary:** `#263D5B` - supporting accents, secondary surfaces, or tonal variation.
...
- **Display / H1:** Delius Swash Caps, `2.5rem`
- **Body:** Delius Swash Caps, `1rem`
