...
App dashboards with purple-themed aesthetic, top-bar navigation, cards, and developer workflows.

Use this style when the interface should feel structured, data-forward, efficient, and highly scannable. The design should be recognizable as Application, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Application
...
- **Primary:** `#9333ea` - main actions, active states, and key highlights.
- **Secondary:** `#a855f7` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#FFFFFF` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#09090b` - primary readable content.
