...
Heavy typography, high contrast, commanding layouts, and strong visual presence.

Use this style when the interface should feel confident, high-contrast, memorable, and energetic. The design should be recognizable as Bold, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Bold
...
- **Primary:** `#0077BC` - main actions, active states, and key highlights.
- **Secondary:** `#009866` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#111111` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#111827` - primary readable content.
- **Neutral:** `#111111` - borders, muted backgrounds, dividers, or inactive UI.
...
- **Display / H1:** Archivo Black, `3rem`
- **Body:** Archivo Black, `1rem`
