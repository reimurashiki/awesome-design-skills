...
Raw anti-design, jarring layouts, concrete-inspired simplicity, and functional minimalism.

Use this style when the interface should feel quiet, clear, focused, and deliberately simple. The design should be recognizable as Brutalism, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Brutalism
...
- **Primary:** `#DD614C` - main actions, active states, and key highlights.
- **Secondary:** `#DAA144` - supporting accents, secondary surfaces, or tonal variation.
...
- **Display / H1:** Darker Grotesque, `3rem`
- **Body:** Darker Grotesque, `1rem`
