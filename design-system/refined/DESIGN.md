...
Curated modern minimalism, elegant serif typography, and understated palettes.

Use this style when the interface should feel readable, paced, typographic, and content-led. The design should be recognizable as Refined, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Refined
...
- **Display / H1:** Playfair Display, `2rem`
