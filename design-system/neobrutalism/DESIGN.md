...
Bold borders, vivid accents, raw high-contrast layouts, and warm surfaces.

Use this style when the interface should feel confident, high-contrast, memorable, and energetic. The design should be recognizable as Neobrutalism, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Neobrutalism
...
- **Primary:** `#FDC800` - main actions, active states, and key highlights.
- **Secondary:** `#432DD7` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#FBFBF9` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#1C293C` - primary readable content.
- **Neutral:** `#FBFBF9` - borders, muted backgrounds, dividers, or inactive UI.
...
- **Display / H1:** Inter, `2.1875rem`
- **Body:** Inter, `0.9375rem`
- **Labels / metadata:** JetBrains Mono, `0.8125rem`
