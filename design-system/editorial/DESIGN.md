...
Magazine-inspired layouts, serif typography, structured grids, and elegant reading.

Use this style when the interface should feel readable, paced, typographic, and content-led. The design should be recognizable as Editorial, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Editorial
...
- **Secondary:** `#f1f1f1` - supporting accents, secondary surfaces, or tonal variation.
...
- **Display / H1:** Gelasio, `2.5rem`
- **Body:** Gelasio, `1rem`
- **Labels / metadata:** Ubuntu Mono, `0.875rem`
