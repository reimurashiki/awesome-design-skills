...
# Spacious Design Style

## Overview

Generous whitespace, consistent padding, grid layouts, and breathing room.

Use this style when the interface should feel quiet, clear, focused, and deliberately simple. The design should be recognizable as Spacious, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Spacious
