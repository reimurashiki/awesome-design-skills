...
shadcn/ui-style clean components, monochrome palette, and utility-first patterns.

Use this style when the interface should feel systematic, component-driven, predictable, and maintainable. The design should be recognizable as Shadcn, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Shadcn
...
- **Primary:** `#000000` - main actions, active states, and key highlights.
- **Secondary:** `#111111` - supporting accents, secondary surfaces, or tonal variation.
