...
Classic block-game energy, playful colors, compact layouts, and bold display fonts.

Use this style when the interface should feel nostalgic, playful, era-aware, and tactile. The design should be recognizable as Tetris, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Tetris
...
- **Primary:** `#1C202B` - main actions, active states, and key highlights.
- **Secondary:** `#7107E7` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#DFE7FF` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#1C398E` - primary readable content.
- **Neutral:** `#DFE7FF` - borders, muted backgrounds, dividers, or inactive UI.
