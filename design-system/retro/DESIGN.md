...
Vintage-inspired typography, nostalgic palettes, and throwback visual elements.

Use this style when the interface should feel nostalgic, playful, era-aware, and tactile. The design should be recognizable as Retro, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Retro
