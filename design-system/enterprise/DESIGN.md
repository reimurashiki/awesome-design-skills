...
# Enterprise Design Style

## Overview

Data-driven workflows, high contrast, drag-and-drop patterns, and structured layouts.

Use this style when the interface should feel structured, data-forward, efficient, and highly scannable. The design should be recognizable as Enterprise, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Enterprise
...
- **Primary:** `#072C2C` - main actions, active states, and key highlights.
- **Secondary:** `#FF5F03` - supporting accents, secondary surfaces, or tonal variation.
- **Surface:** `#EDEADE` - page backgrounds, cards, panels, and layout surfaces.
- **Text:** `#111827` - primary readable content.
- **Neutral:** `#EDEADE` - borders, muted backgrounds, dividers, or inactive UI.
...
- **Body:** Ubuntu, `1rem`
- **Labels / metadata:** Ubuntu Mono, `0.75rem`
