...
Google's Material Design patterns, layered surfaces, dynamic theming, and responsive motion.

Use this style when the interface should feel systematic, component-driven, predictable, and maintainable. The design should be recognizable as Material, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Material
...
- **Primary:** `#6442D6` - main actions, active states, and key highlights.
- **Secondary:** `#C8B3FD` - supporting accents, secondary surfaces, or tonal variation.
...
- **Display / H1:** Roboto, `2rem`
- **Body:** Inter, `1rem`
- **Labels / metadata:** Fira Code, `0.75rem`
...
- Reusable buttons, inputs, cards, tabs, and dialogs
- Tokenized variants and density modes
...
- Follow component anatomy and predictable state patterns.
- Use tokens that map cleanly into implementation.
- Keep variants and density rules explicit.
- Use the defined tokens as the default source of truth.
- Keep component behavior predictable across the product.

## Don't

- Do not fork component behavior unnecessarily.
- Do not style one-off states outside the system.
- Do not break accessibility defaults.
...
- component libraries
- design-system aligned apps
- admin UIs
- forms-heavy products
- consistent enterprise applications
