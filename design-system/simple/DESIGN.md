...
No-frills clarity, neutral colors, intuitive layouts, and unobtrusive UI.

Use this style when the interface should feel quiet, clear, focused, and deliberately simple. The design should be recognizable as Simple, but still prioritize clarity, accessibility, and product fit over decoration.

## Style Intent

This style should help the interface feel:

- coherent and recognizable as Simple
